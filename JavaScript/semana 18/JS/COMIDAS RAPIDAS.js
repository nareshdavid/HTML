function mostrar()
{
        ...
        if(item3.selectedIndex==0)
            ...
            // Calcular Adicionales**********//
                if(document.getElementById('radio4').checked)//cerveza
        {
            document.getElementById('adic0').value=3000;
        }
        else if(document.getElementById('radio5').checked)//helado
            {
                document.getElementById('adic0').value=2500;
            }
            else if (document.getElementById('radio6').checked)//jugo
                {
